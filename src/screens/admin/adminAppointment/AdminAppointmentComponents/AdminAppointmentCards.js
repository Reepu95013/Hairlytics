    ...
    >
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
          ...
          <Text style={[styles.text, { color: themeColor.success }]}>
            upcomming
          </Text>
          <Text style={[styles.text, { color: themeColor.success }]}>
            7:00am
        ...
        <Pressable
          onPress={() => navigation.navigate('AdminAppointmentViewScreen')}
          style={{
...
export default memo(AdminAppointmentCards);
