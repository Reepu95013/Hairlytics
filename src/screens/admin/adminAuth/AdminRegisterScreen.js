        ...
        return (
          <>
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setAccountInfo({ ...accountInfo, mobile: text })
              }
              maxLength={10}
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setAccountInfo({ ...accountInfo, opt: text })
              }
              maxLength={6}
              keyboardType="phone-pad"
            />
        ...
        return (
          <>
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, salonName: text })
              }
            />
            <CustomInputText
              label={t('phone')}
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, salonContact: text })
              }
              keyboardType="phone-pad"
              maxLength={6}
            />
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, category: text })
              }
            />
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, WorkingTime: text })
              }
            />
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, address: text })
              }
              numberOfLines={4}
              multiline={true}
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, city: text })
              }
            />
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, pinCode: text })
              }
              keyboardType="phone-pad"
              maxLength={6}
            />
            ...
            <CustomInputText
              ...
              onChangeText={text =>
                setSalonDetails({ ...salonDetails, texID: text })
              }
              maxLength={20}
            />
          </>
            ...
            <View style={{ gap: 40 }}>
              <View style={{ gap: 12 }}>
                ...
                >
                  ...
                  <CustomButton label={t('upload')} style={{ width: '80%' }} />
                </View>
                <View
                  style={{
                    flexDirection: 'row',
        ...
        return (
          <>
            <CustomInputText
              ...
              onChangeText={text =>
                setBankDetails({ ...bankDetails, accountNo: text })
              }
            />
    ...
    return (
      ...
      >
        <View
          style={[
            styles.progressBar,
            { width: `${progress}%`, backgroundColor: themeColor.primary },
          ]}
        />
      </View>
    );
  ...
  return (
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <SecondLayout screenName={'register'}>
          <StepIndicator />
          <Text style={[commonStyles.largeText, { textAlign: 'center' }]}>
            {t('step')} {step} / 4
          </Text>
          {/* Centered Content */}
